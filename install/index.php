...
file_put_contents(PROJECT_ROOT_DIR."/ConfigEnvDomains.php", '<?php /* This file is auto-generated by Surikata.io installer */ '.$configEnvDomainLanguagesPHP);
...
define("WEBSITE_REWRITE_BASE", REWRITE_BASE.$domainToRender["slug"]."/");
    ...
    file_put_contents(PROJECT_ROOT_DIR."/ConfigEnvDomains.php", $configEnvDomainsPHP);
