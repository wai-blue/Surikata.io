          ...
          "web" => [
            "EN" => [
              ...
              "design" => [
                ...
                "bodyBgColor" => "#ffffff",
                "bodyTextColor" => "#292b2c",
                "bodyLinkColor" => "#666666",
                "bodyHeadingColor" => "#292b2c",

                "headerBgColor" => "#ffffff",
                "headerTextColor" => "#292b2c",
                "headerLinkColor" => "#00ff00",
                "headerHeadingColor" => "#292b2c",

                "footerBgColor" => "#ffffff",
                "footerTextColor" => "#292b2c",
                "footerLinkColor" => "#666666",
                "footerHeadingColor" => "#292b2c",
