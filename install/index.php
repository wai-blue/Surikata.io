...
/*
    ...
    file_put_contents(
      ...
      \Surikata\Installer\HelperFunctions::renderConfigEnvDomains($domainsToInstall)
    );
    ...
    if (in_array("customers", $partsToInstall)) {
      ...
      $customers = \Surikata\Installer\HelperFunctions::loadCsvIntoArray(__DIR__."/content/Customers.csv");
